const chapter11Pptx = [
  {
    ...
    options: [
      { id: 'A', text: 'A complex representation of an entity, focusing on specific details.' },
      { id: 'B', text: 'A simplified view of an entity, highlighting the most significant attributes.' },
      { id: 'C', text: 'A process of converting data into a machine-readable format.' },
      { id: 'D', text: 'A technique for optimizing code execution speed.' }
    ],
    correctAnswers: ['B']
  },
  {
    ...
    options: [
      { id: 'A', text: 'A blueprint for creating data structures.' },
      { id: 'B', text: 'A set of instructions for performing a specific task.' },
      { id: 'C', text: 'An instance of an abstract data type.' },
      { id: 'D', text: 'A variable that holds a memory address.' }
    ],
    correctAnswers: ['C']
  },
  {
